FROM alpine
MAINTAINER Francis Taillon <ftaillon.public@gmail.com>
...
RUN apk update && apk add --no-cache bash nginx php7-fpm php7-cli php7-common php7-json php7-soap php7-simplexml php7-session \
    ...
    && wget --no-check-certificate https://github.com/cesium147/phpvirtualbox/archive/6.1-0.zip -O phpvirtualbox.zip \
